...
class sign_predict:
	...
	def __init__(self):
		signs_class=[]
		with open('/home//nvidia/catkin_ws/src/traffic-sign/src/train_model/signnames.csv', 'rt') as csvfile:
		    reader = csv.DictReader(csvfile, delimiter=',')
		    for row in reader:
		        signs_class.append((row['SignName']))
		self.signsclasses = signs_class

		saver = tf.train.import_meta_graph('/home//nvidia/catkin_ws/src/traffic-sign/src/train_model/my_net_f.ckpt.meta')
		sess = tf.Session(config=tf.ConfigProto(allow_soft_placement=True))
		saver.restore(sess, '/home//nvidia/catkin_ws/src/traffic-sign/src/train_model/my_net_f.ckpt')
